 ...
 *
 * Disassembly of ssdt12.dat, Sat Mar 28 21:53:28 2020
 *
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.NDTT, UnknownObj)
    External (_SB_.PCI0.LPCB.EC0_.SKID, UnknownObj)
    ...
    External (_SB_.PCI0.PEG0.NVDV, IntObj)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (_ROM, 2, NotSerialized)  // _ROM: Read-Only Memory
        {
            ...
            ElseIf (LLess (Local0, 0x00038000))
            {
                ...
                Store (RBF7, ROM1) /* \_SB_.PCI0.PEG0.PEGP._ROM.ROM1 */
            }
            ElseIf (LLess (Local0, 0x00040000))
            {
                Subtract (Local0, 0x00038000, Local0)
                Store (RBF8, ROM1) /* \_SB_.PCI0.PEG0.PEGP._ROM.ROM1 */
            }
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Method (NBCI, 4, Serialized)
        {
            ...
            If (LEqual (Arg2, One))
            {
                ...
                Or (STS0, Zero, STS0) /* \_SB_.PCI0.GFX0.NBCI.STS0 */
                Return (TEMP) /* \_SB_.PCI0.GFX0.NBCI.TEMP */
            }
            ...
            If (LEqual (Arg2, 0x10))
            {
                ...
                {
                    Return (GSV1) /* \_SB_.PCI0.GFX0.GSV1 */
                }

                If (LEqual (BFF0, 0x4452))
                {
                    Return (GSDR) /* \_SB_.PCI0.GFX0.GSDR */
                }
            }
        ...
        Method (HDSM, 4, Serialized)
        {
            ...
            If (LEqual (Arg0, ToUUID ("d4a50b75-65c7-46f7-bfb7-41514cea0244")))
            {
                Store (One, NBC) /* \_SB_.PCI0.GFX0.HDSM.NBC_ */
            }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    And (TEMP, 0x0F, TEMP) /* \_SB_.PCI0.PEG0.PEGP.GPS_.TEMP */
                    If (LEqual (TEMP, 0x04))
                    {
                        Return (Arg3)
                    }
                ...
                Case (0x22)
                {
                    ...
                    {
                        Store (\_SB.PCI0.LPCB.EC0.ECE1, PCAP) /* \_SB_.PCI0.PEG0.PEGP.GPS_.PCAP */
                    }

                    Store (PCAP, \_SB.CPPC) /* External reference */
                    PNOT ()
                ...
                Case (0x2A)
                {
                    ...
                    Switch (ToInteger (PSH0))
                    {
                        ...
                        Case (0x02)
                        {
                            ...
                            {
                                Store (\_SB.PCI0.LPCB.EC0.NDTT, TGPU) /* \_SB_.PCI0.PEG0.PEGP.TGPU */
                            }
                            Else
                            {
