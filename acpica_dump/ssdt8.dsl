 ...
 *
 * Disassembly of ssdt8.dat, Sat Mar 28 21:53:29 2020
 *
                ...
                Device (XHC)
                {
                    ...
                    Device (RHUB)
                    {
                        ...
                        Method (TPLD, 2, Serialized)
                        {
                            ...
                            CreateField (DerefOf (Index (PCKG, Zero)), Zero, 0x07, REV)
                            Store (One, REV) /* \_SB_.PCI0.RP13.PXSX.TBDU.XHC_.RHUB.TPLD.REV_ */
                            CreateField (DerefOf (Index (PCKG, Zero)), 0x40, One, VISI)
                            Store (Arg0, VISI) /* \_SB_.PCI0.RP13.PXSX.TBDU.XHC_.RHUB.TPLD.VISI */
                            CreateField (DerefOf (Index (PCKG, Zero)), 0x57, 0x08, GPOS)
                            Store (Arg1, GPOS) /* \_SB_.PCI0.RP13.PXSX.TBDU.XHC_.RHUB.TPLD.GPOS */
                            CreateField (DerefOf (Index (PCKG, Zero)), 0x4A, 0x04, SHAP)
                            Store (One, SHAP) /* \_SB_.PCI0.RP13.PXSX.TBDU.XHC_.RHUB.TPLD.SHAP */
                            CreateField (DerefOf (Index (PCKG, Zero)), 0x20, 0x10, WID)
                            Store (0x08, WID) /* \_SB_.PCI0.RP13.PXSX.TBDU.XHC_.RHUB.TPLD.WID_ */
                            CreateField (DerefOf (Index (PCKG, Zero)), 0x30, 0x10, HGT)
                            Store (0x03, HGT) /* \_SB_.PCI0.RP13.PXSX.TBDU.XHC_.RHUB.TPLD.HGT_ */
